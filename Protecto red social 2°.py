...
# Solicitud de nombre
nombre = input("Para empezar, escríbeme como te llamas. ")
print()
...
def menu ():
    ...
    print()
    print()
    print('1._________________Cambiar nombre')
    print('2._______________Escribir mensaje')
    print('3.__________________________Salir')
    print('-----------------------------------')
    print()
