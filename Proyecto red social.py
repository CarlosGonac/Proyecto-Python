...
amanteDelCafe = input("¿Eres amante del café? ")
print()
print(amanteDelCafe, " eres amante del café")
print()

espressoOFiltrado = input("¿Prefieres café filtrado o espresso? ")
print()
print("genial, prefieres el café ", espressoOFiltrado)
print()
